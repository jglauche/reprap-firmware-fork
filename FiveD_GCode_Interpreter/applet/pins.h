...
#define EXTRUDER_0_MOTOR_DIR_PIN     (byte)4
#define EXTRUDER_0_HEATER_PIN        (byte)7
#define EXTRUDER_0_FAN_PIN           (byte)-1
#define EXTRUDER_0_TEMPERATURE_PIN  (byte)1    // 57 Analogue input 3
...
#define EXTRUDER_0_STEP_ENABLE_PIN  (signed int)0
#define EXTRUDER_0_LOW_HEAT         (byte)90
#define EXTRUDER_0_HIGH_HEAT        (byte)255
...
#define EXTRUDER_1_STEP_ENABLE_PIN  (signed int)-1  // 7 - Conflicts with the fan; set -ve if no stepper
#define EXTRUDER_1_LOW_HEAT         (byte)0
#define EXTRUDER_1_HIGH_HEAT        (byte)255
*/
...
#define EXTRUDER_1_FAN_PIN           (byte)-1
#define EXTRUDER_1_VALVE_DIR_PIN     (byte)-1
#define EXTRUDER_1_VALVE_ENABLE_PIN  (byte)-1 
#define EXTRUDER_1_STEP_ENABLE_PIN  (signed int)-1
...
#define EXTRUDER_0_ENABLE_PIN (signed int)-1 //30
#define EXTRUDER_0_HEATER_PIN (byte)8
#define EXTRUDER_0_TEMPERATURE_PIN (byte)2 
#define EXTRUDER_0_LOW_HEAT         (byte)130
#define EXTRUDER_0_HIGH_HEAT        (byte)255

#define EXTRUDER_1_MOTOR_SPEED_PIN (byte)23
#define EXTRUDER_1_MOTOR_DIR_PIN (byte)25
