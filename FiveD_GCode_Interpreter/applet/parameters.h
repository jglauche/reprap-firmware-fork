...
#define E_STEPS_PER_MM   8.09022593356151 // drive diameter = 4.7 mm, material in:material out = 36:1, 400 steps per revolution
#define E_STEPS_PER_INCH (E_STEPS_PER_MM*INCHES_TO_MM)
#define E_MOTOR_STEPS    1600

//our maximum feedrates
#define FAST_XY_FEEDRATE 5000.0
#define FAST_Z_FEEDRATE  160.0

// Data for acceleration calculations
// Comment out the next line to turn accelerations off
//#define ACCELERATION_ON
#define SLOW_XY_FEEDRATE 2000.0 // Speed from which to start accelerating
#define SLOW_Z_FEEDRATE 50
