...
#define X_STEPS_PER_MM   4 // 7.99735
#define X_STEPS_PER_INCH (X_STEPS_PER_MM*INCHES_TO_MM)
#define X_MOTOR_STEPS    400
#define INVERT_X_DIR 1

#define Y_STEPS_PER_MM   4 // 7.99735
...
#define E_STEPS_PER_MM  0.5 // 0.706   // 5mm diameter drive - empirically adjusted
